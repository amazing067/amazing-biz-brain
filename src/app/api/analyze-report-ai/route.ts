...
- 현재 점수와 연령을 기준으로 **경도인지장애(MCI)·치매 위험**을 저/중/고 중 하나로 한 문장.
- **중요**: 데이터의 "장기요양등급"은 검진 점수로 **추정한 예상 등급**일 뿐, 실제 공단 판정이 아닙니다. "이미 5등급 판정을 받으신", "판정을 받으신 상태"처럼 **실제 등급 판정을 받은 것처럼 단정하지 말 것**. 반드시 "검진 결과상 5등급 구간으로 추정될 수 있음", "실제 등급은 장기요양 인정 신청·공단 심사 후 결정됩니다" 등으로 완화할 것.
- 과도한 불안을 유발하지 말 것. 예: "현재 검진 결과만으로는 치매 고위험군으로 보기 어렵고, 정기 검진으로 변화를 관찰하는 것이 좋습니다.", "선별 관점에서 저위험 구간에 해당할 수 있습니다."
- 고위험일 때만 "의료기관 정밀 검진 권장" 등 구체적 안내.
